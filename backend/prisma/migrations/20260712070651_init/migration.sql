...
-- CreateEnum
CREATE TYPE "ExpenseCategory" AS ENUM ('FUEL', 'MAINTENANCE', 'TOLL', 'OTHER');
...
CREATE TABLE "Driver" (
    ...
    "phone" TEXT NOT NULL,
    "safetyScore" DECIMAL(3,2) NOT NULL DEFAULT 5.00,
...
CREATE TABLE "Trip" (
    ...
    "plannedDistance" DECIMAL(8,2) NOT NULL,
...
CREATE TABLE "FuelLog" (
    ...
    "vehicleId" INTEGER NOT NULL,
    "tripId" INTEGER,
    "amountLiters" DECIMAL(8,2) NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "Trip_trackingNumber_key" ON "Trip"("trackingNumber");
...
-- AddForeignKey
ALTER TABLE "Maintenance" ADD CONSTRAINT "Maintenance_loggedById_fkey" FOREIGN KEY ("loggedById") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
