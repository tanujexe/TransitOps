        ...
        <div className="flex h-16 items-center justify-between px-5 border-b border-slate-800/80 shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col leading-tight">
              ...
              <span className="text-[10px] text-slate-500 font-medium uppercase tracking-widest">Fleet Manager</span>
            </div>
          </div>
          <button
            onClick={onClose}
                      ...
                      >
                        ...
                        <Icon
                          className={`h-[18px] w-[18px] shrink-0 transition-all duration-200
                            ${isActive ? 'text-brand-orange' : 'text-slate-500 group-hover:text-white group-hover:scale-110'}
                          `}
                        />
                        <span className={`transition-colors duration-200 ${isActive ? 'text-brand-orange font-semibold' : ''}`}>
                          {item.name}
                        </span>
                      </button>
                    )
